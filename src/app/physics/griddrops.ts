...
const LOOT_TABLES: Record<string, LootEntry[]> = {
  ...
  orc1: [
    ...
    { name: 'Armet',  type: 'item',     chance: 1.0,  minQty: 1, maxQty: 1,  mergeable: false, texture: 'icons1', frame: 60, iconSheet: 'assets/icon/icons/icons1.png', iconFrame: 60, scale: 3, order: 2, description: 'Casco de acero forjado. Protege la cabeza en combate.', stats: { hp: 15 } },
  ],
  orc1_elite: [
