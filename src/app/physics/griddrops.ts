...
const RESOURCES_CATALOG: LootEntry[] = [
  ...
  {
    name: 'Madera Tier 3', category: 'Recurso', type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'madera_tier3', icon: 'assets/icon/resources/madera_t3.png',
    scale: 2, order: 6, description: 'Madera de tier 3 obtenida al talar árboles tier 3.',
  },
  ...
  },
  {
    ...
    type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'mineral_tier4',
    icon: 'assets/icon/resources/mining/tier4_drop.png',
    scale: 2, order: 6,
    description: 'Mineral de tier 4 obtenido al minar menas del mapa 1-4.',
  },
  {
    name: 'Mineral Tier 5',
    category: 'Recurso',
    type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'mineral_tier5',
    icon: 'assets/icon/resources/mining/tier5_drop.png',
    scale: 2, order: 6,
    description: 'Mineral de tier 5 obtenido al minar menas del mapa 1-5.',
  },
  {
    name: 'Mineral Tier 6',
    category: 'Recurso',
    type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'mineral_tier6',
    icon: 'assets/icon/resources/mining/tier6_drop.png',
    scale: 2, order: 6,
    description: 'Mineral de tier 6 obtenido al minar menas del mapa 1-6.',
  },
  {
    name: 'Mineral Tier 7',
    category: 'Recurso',
    type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'mineral_tier7',
    icon: 'assets/icon/resources/mining/tier7_drop.png',
    scale: 2, order: 6,
    description: 'Mineral de tier 7 obtenido al minar menas del mapa 1-7.',
  },
  {
    name: 'Mineral Tier 8',
    category: 'Recurso',
    type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'mineral_tier8',
    icon: 'assets/icon/resources/mining/tier8_drop.png',
    scale: 2, order: 6,
    description: 'Mineral de tier 8 obtenido al minar menas del mapa 1-8.',
  },
  {
    name: 'Mineral Tier 9',
    category: 'Recurso',
    type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'mineral_tier9',
    icon: 'assets/icon/resources/mining/tier9_drop.png',
    scale: 2, order: 6,
    description: 'Mineral de tier 9 obtenido al minar menas.',
  },
  {
    name: 'Mineral Tier 10',
    category: 'Recurso',
    type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'mineral_tier10',
    icon: 'assets/icon/resources/mining/tier10_drop.png',
    scale: 2, order: 6,
  ...
  {
    name: 'Gema Tier 2', category: 'Recurso', type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'gem_tier2', icon: 'assets/icon/resources/gems/gem2_drop.png',
    scale: 2, order: 6, description: 'Gema de tier 2 obtenida al minar nodos de gema.',
  },
  {
    name: 'Gema Tier 3', category: 'Recurso', type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'gem_tier3', icon: 'assets/icon/resources/gems/gem3_drop.png',
    scale: 2, order: 6, description: 'Gema de tier 3 obtenida al minar nodos de gema.',
  },
  {
    name: 'Gema Tier 4', category: 'Recurso', type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'gem_tier4', icon: 'assets/icon/resources/gems/gem4_drop.png',
    scale: 2, order: 6, description: 'Gema de tier 4 obtenida al minar nodos de gema.',
  },
  {
    name: 'Gema Tier 5', category: 'Recurso', type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'gem_tier5', icon: 'assets/icon/resources/gems/gem5_drop.png',
    scale: 2, order: 6, description: 'Gema de tier 5 obtenida al minar nodos de gema.',
  },
  {
    name: 'Gema Tier 6', category: 'Recurso', type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'gem_tier6', icon: 'assets/icon/resources/gems/gem6_drop.png',
    scale: 2, order: 6, description: 'Gema de tier 6 obtenida al minar nodos de gema.',
  },
  {
    name: 'Gema Tier 7', category: 'Recurso', type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'gem_tier7', icon: 'assets/icon/resources/gems/gem7_drop.png',
    scale: 2, order: 6, description: 'Gema de tier 7 obtenida al minar nodos de gema.',
  },
  {
    name: 'Gema Tier 8', category: 'Recurso', type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'gem_tier8', icon: 'assets/icon/resources/gems/gem8_drop.png',
    scale: 2, order: 6, description: 'Gema de tier 8 obtenida al minar nodos de gema.',
  },
  {
    name: 'Gema Tier 9', category: 'Recurso', type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'gem_tier9', icon: 'assets/icon/resources/gems/gem9_drop.png',
    scale: 2, order: 6, description: 'Gema de tier 9 obtenida al minar nodos de gema.',
  },
  {
    name: 'Gema Tier 10', category: 'Recurso', type: 'item',
    chance: 1, minQty: 1, maxQty: 1, mergeable: true,
    texture: 'gem_tier10', icon: 'assets/icon/resources/gems/gem10_drop.png',
    scale: 2, order: 6, description: 'Gema de tier 10 obtenida al minar nodos de gema.',
  },
  {
    name: 'Carbón',
    category: 'Recurso',
